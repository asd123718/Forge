...
interface IToolCallFileEdit {
	readonly edit: ISessionFileDiff;
	readonly isComplete: boolean;
}

function getToolCallFileEdits(toolCall: ToolCallState): IToolCallFileEdit[] {
	const edits: IToolCallFileEdit[] = [];
